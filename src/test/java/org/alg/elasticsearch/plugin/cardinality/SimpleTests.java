...
import org.alg.elasticsearch.search.aggregations.cardinality.Cardinality;
import org.alg.elasticsearch.search.aggregations.cardinality.CardinalityBuilder;
...
public class SimpleTests extends Assert {
    ...
    private final static boolean STRESS = false; // disable stress tests
    ...
    public void assertPluginLoaded() {
        ...
        assertEquals(nodesInfoResponse.getNodes()[0].getPlugins().getInfos().get(0).getName(), "index-cardinality");
    ...
    public void assertTermCountActionOneShardString() {
        ...
        CardinalityResponse response = client.execute(CardinalityAction.INSTANCE, new CardinalityRequest("test")).actionGet();
        assertEquals(response.getCount(), 3);

        response = client.execute(CardinalityAction.INSTANCE, new CardinalityRequest("test").withField("field0")).actionGet();
        assertEquals(response.getCount(), 2);

        response = client.execute(CardinalityAction.INSTANCE, new CardinalityRequest("test").withField("field1")).actionGet();
    ...
    public void assertTermCountActionOneShardNumerical() {
        ...
        CardinalityResponse response = client.execute(CardinalityAction.INSTANCE, new CardinalityRequest("test1").withField("field2")).actionGet();
        assertEquals(response.getCount(), 2);
    }
    ...
    public void assertTermCountActionTwoShard() {
        ...
        CardinalityResponse response = client.execute(CardinalityAction.INSTANCE, new CardinalityRequest("test2")).actionGet();
    ...
    public void assertTermCountActionTwoIndices() {
        ...
        CardinalityResponse response = client.execute(CardinalityAction.INSTANCE, new CardinalityRequest("test2a")).actionGet();
    ...
    public void assertTermCountAggregatorOneShard() {
        ...
        SearchResponse searchResponse = client.prepareSearch("test3")
                ...
                .addAggregation(new CardinalityBuilder("uniq0").field("field0"))
                .addAggregation(new CardinalityBuilder("uniq1").field("field1"))
                .execute().actionGet();
        Cardinality count0 = searchResponse.getAggregations().get("uniq0");
        assertNotNull(count0);
        assertEquals(2, count0.getValue());
        
        Cardinality count1 = searchResponse.getAggregations().get("uniq1");
    ...
    public void assertTermCountAggregatorLotsOfEmptyShard() {
        ...
        SearchResponse searchResponse = client.prepareSearch("test6")
                .setQuery(matchAllQuery())
                .addAggregation(new CardinalityBuilder("uniq0").field("field_inexistent"))
                .execute().actionGet();
        Cardinality count0 = searchResponse.getAggregations().get("uniq0");
        assertNotNull(count0);
    ...
    public void assertTermCountAggregatorInexistentField() {
        ...
        SearchResponse searchResponse = client.prepareSearch("test7")
                .setQuery(matchAllQuery())
                .addAggregation(new CardinalityBuilder("uniq0").field("field1"))
                .execute().actionGet();
        Cardinality count0 = searchResponse.getAggregations().get("uniq0");
        assertNotNull(count0);
    ...
    public void assertTermCountAggregatorStressTestOneShard() {
        ...
        SearchResponse searchResponse = client.prepareSearch("test8")
                ...
                .addAggregation(new CardinalityBuilder("uniq0").field("field0"))
                .execute().actionGet();
        Cardinality count = searchResponse.getAggregations().get("uniq0");
        assertNotNull(count);
    ...
    @Test(enabled=STRESS)
    public void assertTermCountAggregatorStressTestEmptyIndexes() {
