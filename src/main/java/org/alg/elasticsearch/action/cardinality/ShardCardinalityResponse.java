...
class ShardCardinalityResponse extends BroadcastShardOperationResponse {

    private HyperLogLogPlus counter;

    ShardCardinalityResponse() {
    }

    public ShardCardinalityResponse(String index, int shardId, HyperLogLogPlus counter) {
        super(index, shardId);
