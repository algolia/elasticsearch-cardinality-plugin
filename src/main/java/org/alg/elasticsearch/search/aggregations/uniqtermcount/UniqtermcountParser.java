 ...
 *
 */
public class UniqtermcountParser implements Aggregator.Parser {

    @Override
    public String type() {
        return InternalUniqtermcount.TYPE.name();
    }
    ...
    public AggregatorFactory parse(String aggregationName, XContentParser parser, SearchContext context) throws IOException {
        ...
        if (mapper == null) {
            ...
            return new UniqtermcountAggregator.Factory(aggregationName, config);
        }
